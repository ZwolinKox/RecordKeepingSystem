						...
						<div class="col-auto mt-3 mb-3">
							...
							<div class="row">
								...
								<div class="form-group col-lg-6 m-auto">
										...
										<input type="date" class="form-control" id="norder_out" name="zakonczenie" placeholder="">
								</div>
							...
							<div class="row">
								...
								<label class="mx-auto my-1 text-center"><strong>Szacowana cena naprawy, którą akceptuje klient w momencie przyjmowania naprawy</strong></label>
					...
					<div class="card">
						...
						<div class="col-auto my-3">
							...
							<div class="form-check mt-2">
								...
								<input class="form-check-input" type="radio" name="dostarczenie" id="norder_dlvr1" value="1" checked>
							...
							<div class="form-check">
								...
								<input class="form-check-input" type="radio" name="dostarczenie" id="norder_dlvr2" value="2" >
							...
							<div class="form-check mb-2">
								...
								<input class="form-check-input" type="radio" name="dostarczenie" id="norder_dlvr3" value="3" >
							...
							<div class="form-check mt-2">
								...
								<input class="form-check-input" type="radio" name="odbior" id="norder_pick1" value="1" checked>
